...
import { Brain, MessageSquare, Map, CalendarDays, LayoutDashboard, LogOut, Menu, X, BookOpen } from "lucide-react";
...
export default function Navbar() {
  ...
  return (
    <nav className={`fixed top-0 left-0 right-0 z-50 glass-strong border-b transition-all duration-300 ${scrolled ? "border-border/60 shadow-md" : "border-border/30"}`}>
